...
export function buildTaskInfoFromMappedTask({
	...
	return {
		...
		planningState: mappedTask.planningState ?? "anytime",
		areas: Array.isArray(mappedTask.areas) ? mappedTask.areas : [],
		goals: Array.isArray(mappedTask.goals) ? mappedTask.goals : [],
		relations: Array.isArray(mappedTask.relations) ? mappedTask.relations : [],
		totalTrackedTime,
		isBlocked,
