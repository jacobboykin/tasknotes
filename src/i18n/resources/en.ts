...
export const en: TranslationTree = {
			...
			basesIntegration: {
				...
				viewCommands: {
					...
					commands: {
						...
						entities: "Open projects, areas & goals",
	...
	commands: {
		...
		openPlanningView: "Open planning view",
		openEntitiesView: "Open projects, areas & goals",
		quickFind: "Quick find",
		captureInbox: "Capture task to inbox",
		captureToday: "Create task for today",
	...
	modals: {
		...
		task: {
			...
			areasLabel: "Areas",
			areasPlaceholder: "Choose areas...",
			goalsLabel: "Goals",
			goalsPlaceholder: "Choose goals...",
			relationsLabel: "Related notes",
			relationsPlaceholder: "Choose notes...",
			projectSectionLabel: "Project section",
			projectSectionPlaceholder: "Choose or name a section...",
			...
			planning: {
				label: "When",
				description: "Choose when this task should become actionable.",
				inbox: "Inbox",
				anytime: "Anytime",
				today: "Today",
				someday: "Someday",
	...
	contextMenus: {
		task: {
			...
			occurrenceNotes: {
				title: "Occurrence notes",
				virtual: "Virtual occurrences",
				onSchedule: "Repeat on schedule",
				afterCompletion: "Repeat after completion",
				noDeadline: "No deadline",
				deadlineOnStart: "Deadline on start date",
				startBeforeDeadline: "Start {days} days before deadline",
				startOffsetTitle: "Start days before deadline",
				startOffsetPlaceholder: "Enter a number, or 'none'",
				invalidStartOffset: "Enter a whole number of days, or 'none'",
				notices: {
					virtual: "Recurring task uses virtual occurrences",
					onSchedule: "Independent occurrences will be created on schedule",
					afterCompletion: "The next occurrence will be created after completion",
					updateFailed: "Failed to update occurrence behavior: {message}",
					deadlineFailed: "Failed to update recurrence deadline: {message}",
				},
			},
			...
			quickReminders: {
				...
				notices: {
				updatePlanningFailure: "Failed to update when this task is actionable",
