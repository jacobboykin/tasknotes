...
export const zh: TranslationTree = {
	...
	commands: {
		...
		openPlanningView: "打开规划视图",
		openEntitiesView: "打开项目、领域和目标",
		quickFind: "快速查找",
		captureInbox: "将任务添加到收件箱",
		captureToday: "创建今日任务",
		createProject: "创建项目",
		createArea: "创建领域",
		createGoal: "创建目标",
	...
	modals: {
		...
		task: {
			...
			contextsLabel: "上下文",
			areasLabel: "领域",
			areasPlaceholder: "选择领域...",
			goalsLabel: "目标",
			goalsPlaceholder: "选择目标...",
			relationsLabel: "相关笔记",
			relationsPlaceholder: "选择笔记...",
			projectSectionLabel: "项目分区",
			projectSectionPlaceholder: "选择或命名分区...",
			reviewDateLabel: "复盘日期",
	...
	contextMenus: {
		task: {
			...
			occurrenceNotes: {
				...
				virtual: "虚拟实例",
				onSchedule: "按计划重复",
				afterCompletion: "完成后重复",
				noDeadline: "无截止日期",
				deadlineOnStart: "截止日期与开始日期相同",
				startBeforeDeadline: "在截止日期前 {days} 天开始",
				startOffsetTitle: "提前于截止日期的天数",
				startOffsetPlaceholder: "输入数字或 'none'",
				invalidStartOffset: "请输入整数天数或 'none'",
				notices: {
					virtual: "重复任务使用虚拟实例",
					onSchedule: "将按计划创建独立实例",
					afterCompletion: "完成后将创建下一个实例",
					updateFailed: "无法更新重复实例行为：{message}",
					deadlineFailed: "无法更新重复截止日期：{message}",
				},
			},
			createSubtask: "创建子任务",
			dependencies: {
			...
			notices: {
				updatePlanningFailure: "无法更新任务规划",
