...
export const ru: TranslationTree = {
		...
		general: {
			...
			folderManagement: {
				...
				excludedFolders: {
					...
					description: "Список папок через запятую, которые следует исключить из индексации задач и предложений связей"
				}
			},
			frontmatter: {
				header: "Frontmatter",
			...
			basesIntegration: {
				...
				viewCommands: {
					...
					commands: {
						...
						entities: "Открыть проекты, сферы и цели",
	...
	commands: {
		...
		openPlanningView: "Открыть представление планирования",
		openEntitiesView: "Открыть проекты, сферы и цели",
		quickFind: "Быстрый поиск",
		captureInbox: "Добавить задачу во входящие",
		captureToday: "Создать задачу на сегодня",
	...
	modals: {
		...
		task: {
			...
			areasLabel: "Сферы",
			areasPlaceholder: "Выберите сферы...",
			goalsLabel: "Цели",
			goalsPlaceholder: "Выберите цели...",
			relationsLabel: "Связанные заметки",
			relationsPlaceholder: "Выберите заметки...",
			projectSectionLabel: "Раздел проекта",
			projectSectionPlaceholder: "Выберите или назовите раздел...",
			reviewDateLabel: "Дата обзора",
			...
			planning: {
				label: "Когда",
				description: "Выберите, когда эта задача станет доступной.",
				inbox: "Входящие",
				anytime: "В любое время",
				today: "Сегодня",
				someday: "Когда-нибудь",
				scheduled: "Запланировано · {date}",
			},
			unsavedChanges: {
	...
	contextMenus: {
		task: {
			...
			occurrenceNotes: {
				title: "Заметки повторений",
				virtual: "Виртуальные повторения",
				onSchedule: "Повторять по расписанию",
				afterCompletion: "Повторять после завершения",
				noDeadline: "Без срока",
				deadlineOnStart: "Срок в дату начала",
				startBeforeDeadline: "Начинать за {days} дней до срока",
				startOffsetTitle: "Дни до срока",
				startOffsetPlaceholder: "Введите число или 'none'",
				invalidStartOffset: "Введите целое число дней или 'none'",
				notices: {
					virtual: "Повторяющаяся задача использует виртуальные повторения",
					onSchedule: "Независимые повторения будут создаваться по расписанию",
					afterCompletion: "Следующее повторение будет создано после завершения",
					updateFailed: "Не удалось изменить поведение повторений: {message}",
					deadlineFailed: "Не удалось изменить срок повторения: {message}",
				},
			},
			...
			notices: {
				updatePlanningFailure: "Не удалось обновить планирование задачи",
