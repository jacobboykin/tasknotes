...
export const ja: TranslationTree = {
	...
	commands: {
		...
		openPlanningView: "プランニングビューを開く",
		openEntitiesView: "プロジェクト、エリア、目標を開く",
		quickFind: "クイック検索",
		captureInbox: "タスクを受信箱に追加",
		captureToday: "今日のタスクを作成",
	...
	modals: {
		...
		task: {
			...
			areasLabel: "エリア",
			areasPlaceholder: "エリアを選択...",
			goalsLabel: "目標",
			goalsPlaceholder: "目標を選択...",
			relationsLabel: "関連ノート",
			relationsPlaceholder: "ノートを選択...",
			projectSectionLabel: "プロジェクトセクション",
			projectSectionPlaceholder: "セクションを選択または入力...",
			reviewDateLabel: "レビュー日",
			...
			planning: {
				label: "いつ",
				description: "このタスクをいつ実行可能にするか選択します。",
				inbox: "受信箱",
				anytime: "いつでも",
				today: "今日",
				someday: "いつか",
	...
	contextMenus: {
		task: {
			...
			occurrenceNotes: {
				title: "繰り返しのノート",
				virtual: "仮想の繰り返し",
				onSchedule: "予定どおりに繰り返す",
				afterCompletion: "完了後に繰り返す",
				noDeadline: "期限なし",
				deadlineOnStart: "開始日を期限にする",
				startBeforeDeadline: "期限の{days}日前に開始",
				startOffsetTitle: "期限の何日前に開始するか",
				startOffsetPlaceholder: "数値または 'none' を入力",
				invalidStartOffset: "整数の日数または 'none' を入力してください",
				notices: {
					virtual: "繰り返しタスクは仮想の繰り返しを使用します",
					onSchedule: "独立した繰り返しが予定どおりに作成されます",
					afterCompletion: "完了後に次の繰り返しが作成されます",
					updateFailed: "繰り返し動作を更新できませんでした: {message}",
					deadlineFailed: "繰り返し期限を更新できませんでした: {message}",
				},
			},
			...
			notices: {
				updatePlanningFailure: "タスクのプランニングを更新できませんでした",
