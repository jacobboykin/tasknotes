...
export const fr: TranslationTree = {
			...
			basesIntegration: {
				...
				viewCommands: {
					...
					commands: {
						...
						entities: "Ouvrir les projets, domaines et objectifs",
	...
	commands: {
		...
		openPlanningView: "Ouvrir la vue planification",
		openEntitiesView: "Ouvrir les projets, domaines et objectifs",
		quickFind: "Recherche rapide",
		captureInbox: "Capturer une tâche dans la boîte de réception",
		captureToday: "Créer une tâche pour aujourd’hui",
		createProject: "Créer un projet",
		createArea: "Créer un domaine",
		createGoal: "Créer un objectif",
		editCurrentEntity: "Modifier le projet, domaine ou objectif actuel",
		editCurrentEntitySaveFailure: "Impossible d’enregistrer les relations du projet, du domaine ou de l’objectif.",
	...
	modals: {
		...
		task: {
			...
			areasLabel: "Domaines",
			areasPlaceholder: "Choisir des domaines...",
			goalsLabel: "Objectifs",
			goalsPlaceholder: "Choisir des objectifs...",
			relationsLabel: "Notes associées",
			relationsPlaceholder: "Choisir des notes...",
			projectSectionLabel: "Section du projet",
			projectSectionPlaceholder: "Choisir ou nommer une section...",
			...
			planning: {
				label: "Quand",
				description: "Choisissez quand cette tâche doit devenir disponible.",
				inbox: "Boîte de réception",
				anytime: "À tout moment",
				today: "Aujourd’hui",
				someday: "Un jour",
				scheduled: "Planifiée · {date}",
			},
			unsavedChanges: {
	...
	contextMenus: {
		task: {
			...
			occurrenceNotes: {
				title: "Notes d’occurrence",
				virtual: "Occurrences virtuelles",
				onSchedule: "Répéter selon le calendrier",
				afterCompletion: "Répéter après achèvement",
				noDeadline: "Aucune échéance",
				deadlineOnStart: "Échéance à la date de début",
				startBeforeDeadline: "Commencer {days} jours avant l’échéance",
				startOffsetTitle: "Jours avant l’échéance",
				startOffsetPlaceholder: "Saisissez un nombre ou 'none'",
				invalidStartOffset: "Saisissez un nombre entier de jours ou 'none'",
				notices: {
					virtual: "La tâche récurrente utilise des occurrences virtuelles",
					onSchedule: "Des occurrences indépendantes seront créées selon le calendrier",
					afterCompletion: "La prochaine occurrence sera créée après achèvement",
					updateFailed: "Impossible de modifier le comportement des occurrences : {message}",
					deadlineFailed: "Impossible de modifier l’échéance récurrente : {message}",
				},
			},
			...
			notices: {
				updatePlanningFailure: "Impossible de mettre à jour la planification de la tâche",
