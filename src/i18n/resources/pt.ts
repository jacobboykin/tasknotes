...
export const pt: TranslationTree = {
			...
			basesIntegration: {
				...
				viewCommands: {
					...
					commands: {
						...
						entities: "Abrir projetos, áreas e objetivos",
	...
	commands: {
		...
		openPlanningView: "Abrir visualização de planejamento",
		openEntitiesView: "Abrir projetos, áreas e objetivos",
		quickFind: "Busca rápida",
		captureInbox: "Capturar tarefa na caixa de entrada",
		captureToday: "Criar tarefa para hoje",
		createProject: "Criar projeto",
		createArea: "Criar área",
		createGoal: "Criar objetivo",
		editCurrentEntity: "Editar projeto, área ou objetivo atual",
		editCurrentEntitySaveFailure: "Não foi possível salvar as relações do projeto, área ou objetivo.",
	...
	modals: {
		...
		task: {
			...
			areasLabel: "Áreas",
			areasPlaceholder: "Escolher áreas...",
			goalsLabel: "Objetivos",
			goalsPlaceholder: "Escolher objetivos...",
			relationsLabel: "Notas relacionadas",
			relationsPlaceholder: "Escolher notas...",
			projectSectionLabel: "Seção do projeto",
			projectSectionPlaceholder: "Escolher ou nomear uma seção...",
			reviewDateLabel: "Data de revisão",
			...
			planning: {
				label: "Quando",
				description: "Escolha quando esta tarefa deve ficar disponível.",
				inbox: "Caixa de entrada",
				anytime: "A qualquer momento",
				today: "Hoje",
				someday: "Algum dia",
				scheduled: "Agendada · {date}",
			},
			unsavedChanges: {
	...
	contextMenus: {
		task: {
			...
			occurrenceNotes: {
				title: "Notas de ocorrência",
				virtual: "Ocorrências virtuais",
				onSchedule: "Repetir conforme a agenda",
				afterCompletion: "Repetir após a conclusão",
				noDeadline: "Sem prazo",
				deadlineOnStart: "Prazo na data de início",
				startBeforeDeadline: "Começar {days} dias antes do prazo",
				startOffsetTitle: "Dias antes do prazo",
				startOffsetPlaceholder: "Digite um número ou 'none'",
				invalidStartOffset: "Digite um número inteiro de dias ou 'none'",
				notices: {
					virtual: "A tarefa recorrente usa ocorrências virtuais",
					onSchedule: "Ocorrências independentes serão criadas conforme a agenda",
					afterCompletion: "A próxima ocorrência será criada após a conclusão",
					updateFailed: "Falha ao atualizar o comportamento das ocorrências: {message}",
					deadlineFailed: "Falha ao atualizar o prazo recorrente: {message}",
				},
			},
			...
			notices: {
				updatePlanningFailure: "Falha ao atualizar o planejamento da tarefa",
