...
export const es: TranslationTree = {
			...
			basesIntegration: {
				...
				viewCommands: {
					...
					commands: {
						...
						entities: "Abrir proyectos, áreas y objetivos",
	...
	commands: {
		...
		openPlanningView: "Abrir vista de planificación",
		openEntitiesView: "Abrir proyectos, áreas y objetivos",
		quickFind: "Búsqueda rápida",
		captureInbox: "Capturar tarea en la bandeja de entrada",
		captureToday: "Crear tarea para hoy",
		createProject: "Crear proyecto",
		createArea: "Crear área",
		createGoal: "Crear objetivo",
		editCurrentEntity: "Editar proyecto, área u objetivo actual",
		editCurrentEntitySaveFailure: "No se pudieron guardar las relaciones del proyecto, área u objetivo.",
	...
	modals: {
		...
		task: {
			...
			areasLabel: "Áreas",
			areasPlaceholder: "Elegir áreas...",
			goalsLabel: "Objetivos",
			goalsPlaceholder: "Elegir objetivos...",
			relationsLabel: "Notas relacionadas",
			relationsPlaceholder: "Elegir notas...",
			projectSectionLabel: "Sección del proyecto",
			projectSectionPlaceholder: "Elegir o nombrar una sección...",
			...
			planning: {
				label: "Cuándo",
				description: "Elige cuándo esta tarea debe estar disponible.",
	...
	contextMenus: {
		task: {
			...
			occurrenceNotes: {
				title: "Notas de ocurrencia",
				virtual: "Ocurrencias virtuales",
				onSchedule: "Repetir según el calendario",
				afterCompletion: "Repetir al completar",
				noDeadline: "Sin fecha límite",
				deadlineOnStart: "Fecha límite en la fecha de inicio",
				startBeforeDeadline: "Comenzar {days} días antes de la fecha límite",
				startOffsetTitle: "Días de antelación a la fecha límite",
				startOffsetPlaceholder: "Introduce un número o 'none'",
				invalidStartOffset: "Introduce un número entero de días o 'none'",
				notices: {
					virtual: "La tarea recurrente usa ocurrencias virtuales",
					onSchedule: "Las ocurrencias independientes se crearán según el calendario",
					afterCompletion: "La siguiente ocurrencia se creará al completar",
					updateFailed: "No se pudo actualizar el comportamiento de recurrencia: {message}",
					deadlineFailed: "No se pudo actualizar la fecha límite recurrente: {message}",
				},
			},
			...
			notices: {
				updatePlanningFailure: "No se pudo actualizar la planificación de la tarea",
