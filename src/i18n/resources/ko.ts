...
export const ko: TranslationTree = {
	...
	commands: {
		...
		openPlanningView: "계획 뷰 열기",
		openEntitiesView: "프로젝트, 영역 및 목표 열기",
		quickFind: "빠른 찾기",
		captureInbox: "받은 편지함에 작업 추가",
		captureToday: "오늘 작업 만들기",
	...
	modals: {
		...
		task: {
			...
			contextsLabel: "컨텍스트",
			areasLabel: "영역",
			areasPlaceholder: "영역 선택...",
			goalsLabel: "목표",
			goalsPlaceholder: "목표 선택...",
			relationsLabel: "관련 노트",
			relationsPlaceholder: "노트 선택...",
			projectSectionLabel: "프로젝트 섹션",
			projectSectionPlaceholder: "섹션 선택 또는 입력...",
			reviewDateLabel: "검토 날짜",
			...
			planning: {
				label: "언제",
				description: "이 작업을 언제 실행 가능하게 할지 선택하세요.",
				inbox: "받은 편지함",
				anytime: "언제든지",
				today: "오늘",
				someday: "언젠가",
	...
	contextMenus: {
		task: {
			...
			occurrenceNotes: {
				title: "반복 항목 노트",
				virtual: "가상 반복 항목",
				onSchedule: "일정에 따라 반복",
				afterCompletion: "완료 후 반복",
				noDeadline: "마감일 없음",
				deadlineOnStart: "시작일을 마감일로 설정",
				startBeforeDeadline: "마감일 {days}일 전에 시작",
				startOffsetTitle: "마감일 전 시작 일수",
				startOffsetPlaceholder: "숫자 또는 'none' 입력",
				invalidStartOffset: "정수 일수 또는 'none'을 입력하세요",
				notices: {
					virtual: "반복 작업이 가상 반복 항목을 사용합니다",
					onSchedule: "독립적인 반복 항목이 일정에 따라 생성됩니다",
					afterCompletion: "완료 후 다음 반복 항목이 생성됩니다",
					updateFailed: "반복 동작을 업데이트하지 못했습니다: {message}",
					deadlineFailed: "반복 마감일을 업데이트하지 못했습니다: {message}",
				},
			},
			...
			notices: {
				updatePlanningFailure: "작업 계획을 업데이트하지 못했습니다",
