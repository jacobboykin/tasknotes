...
export const de: TranslationTree = {
			...
			basesIntegration: {
				...
				viewCommands: {
					...
					commands: {
						...
						entities: "Projekte, Bereiche und Ziele öffnen",
	...
	commands: {
		...
		openPlanningView: "Planungsansicht öffnen",
		openEntitiesView: "Projekte, Bereiche und Ziele öffnen",
		quickFind: "Schnellsuche",
		captureInbox: "Aufgabe im Eingang erfassen",
		captureToday: "Aufgabe für heute erstellen",
	...
	modals: {
		...
		task: {
			...
			areasLabel: "Bereiche",
			areasPlaceholder: "Bereiche auswählen...",
			goalsLabel: "Ziele",
			goalsPlaceholder: "Ziele auswählen...",
			relationsLabel: "Verknüpfte Notizen",
			relationsPlaceholder: "Notizen auswählen...",
			projectSectionLabel: "Projektabschnitt",
			projectSectionPlaceholder: "Abschnitt auswählen oder benennen...",
			...
			planning: {
				label: "Wann",
				description: "Wählen Sie, wann diese Aufgabe bearbeitet werden soll.",
				inbox: "Eingang",
				anytime: "Jederzeit",
				today: "Heute",
				someday: "Irgendwann",
				scheduled: "Geplant · {date}",
			},
			unsavedChanges: {
	...
	contextMenus: {
		task: {
			...
			occurrenceNotes: {
				title: "Vorkommensnotizen",
				virtual: "Virtuelle Vorkommen",
				onSchedule: "Nach Zeitplan wiederholen",
				afterCompletion: "Nach Abschluss wiederholen",
				noDeadline: "Keine Frist",
				deadlineOnStart: "Frist am Startdatum",
				startBeforeDeadline: "{days} Tage vor der Frist beginnen",
				startOffsetTitle: "Tage vor der Frist beginnen",
				startOffsetPlaceholder: "Zahl oder „none“ eingeben",
				invalidStartOffset: "Ganze Anzahl von Tagen oder „none“ eingeben",
				notices: {
					virtual: "Die wiederkehrende Aufgabe verwendet virtuelle Vorkommen",
					onSchedule: "Unabhängige Vorkommen werden nach Zeitplan erstellt",
					afterCompletion: "Das nächste Vorkommen wird nach Abschluss erstellt",
					updateFailed: "Vorkommensverhalten konnte nicht aktualisiert werden: {message}",
					deadlineFailed: "Wiederholungsfrist konnte nicht aktualisiert werden: {message}",
				},
			},
			...
			notices: {
				updatePlanningFailure: "Planung der Aufgabe konnte nicht aktualisiert werden",
